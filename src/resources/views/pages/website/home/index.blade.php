...
<body id="page-top">
        ...
        <div class="container" style="justify-content: end !important">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#scheduleTime">Agende um Horário</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="masthead d-flex">
        <div class="container align-self-center">
            ...
            <a class="btn btn-primary btn-xl text-uppercase shadow" href="#scheduleTime">Agende um horário</a>
        </div>
    </header>

    <section class="page-section" id="scheduleTime" style="height: 100vh;">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Agendar Horário</h2>
                <h3 class="section-subheading text-muted">Garanta que seu cabelo e barba esteja sempre na régua! Marque um horário.</h3>
            </div>
    ...
    <a class="scroll-to-top rounded-circle bg-warning" href="#page-top" style="display: none;" id="scrollToTop">
